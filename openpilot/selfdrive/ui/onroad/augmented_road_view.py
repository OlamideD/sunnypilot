...
# SPRINT17D_TESLA_VIEW: camera-less onroad view. The flag file is checked every 2 s so the camera
# can be restored live by deleting it. Nothing here touches driving or driver monitoring.
